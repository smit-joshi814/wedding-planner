...
<!-- No Ui Slider -->
<script
	src="resources/libs/nouislider/dist/nouislider.min.js" defer></script>

<!-- Lite Picker -->
<script src="resources/libs/litepicker/dist/litepicker.js"
	defer></script>

<!-- Tom Select -->
<script
	src="resources/libs/tom-select/dist/js/tom-select.base.min.js"
	defer></script>
