									...
									<div class="card-body">
										...
										<div class="mb-3">
											<label class="form-label required">Select Service
												Item</label> <select class="form-select-item" id="select-service-item"
												required>
									...
									<div class="card-body">
										<div class="mb-3">
											<label class="form-label required">Select Variation</label> <select
												class="form-select" id="select-variation" required>
										...
										<div class="mb-3">
											<label class="form-label required">Select Variation
												...
												id="select-variation-option" required>
									...
									<table class="table">
										...
										<tbody class="table-tbody">
											<tr>
												...
												<td class="sort-date" data-date="1628071164">August 04,
													2021</td>
											...
											<tr>
												...
												<td class="sort-city">Kolm̴rden Sweden</td>
														...
														<div class="col">
															<div class="progress" style="width: 5rem">
																<div class="progress-bar" style="width: 98%"
																	...
																	aria-valuemax="100" aria-label="98% Complete">
														...
														<div class="col">
															<div class="progress" style="width: 5rem">
																<div class="progress-bar" style="width: 46%"
																	...
																	aria-valuemax="100" aria-label="46% Complete">
											...
											<tr>
												...
												<td class="sort-city">Six Flags Great Adventure, United
													States</td>
														...
														<div class="col">
															<div class="progress" style="width: 5rem">
																<div class="progress-bar" style="width: 29%"
																	...
																	aria-valuemax="100" aria-label="29% Complete">
														...
														<div class="col">
															<div class="progress" style="width: 5rem">
																<div class="progress-bar" style="width: 57%"
																	...
																	aria-valuemax="100" aria-label="57% Complete">
											...
											<tr>
												...
												<td class="sort-type">S&amp;S Power 4th Dimension,
													Steel</td>
														...
														<div class="col">
															<div class="progress" style="width: 5rem">
																<div class="progress-bar" style="width: 91%"
																	...
																	aria-valuemax="100" aria-label="91% Complete">
														...
														<div class="col">
															<div class="progress" style="width: 5rem">
																<div class="progress-bar" style="width: 24%"
																	...
																	aria-valuemax="100" aria-label="24% Complete">
											...
											<tr>
												...
												<td class="sort-score">98,2%</td>
												<td class="sort-date" data-date="1565107347">August 06,
													2019</td>
											...
											<tr>
												...
												<td class="sort-date" data-date="1564805623">August 03,
													2019</td>
														...
														<div class="col">
															<div class="progress" style="width: 5rem">
																<div class="progress-bar" style="width: 42%"
																	...
																	aria-valuemax="100" aria-label="42% Complete">
														...
														<div class="col">
															<div class="progress" style="width: 5rem">
																<div class="progress-bar" style="width: 54%"
																	...
																	aria-valuemax="100" aria-label="54% Complete">
											...
											<tr>
												...
												<td class="sort-city">Silver Dollar City, United States
												</td>
												<td class="sort-type">RMC Hybrid</td>
														...
														<div class="col">
															<div class="progress" style="width: 5rem">
																<div class="progress-bar" style="width: 64%"
																	...
																	aria-valuemax="100" aria-label="64% Complete">
				...
				.addEventListener(
						...
						function() {
							...
							window.TomSelect
									&& new TomSelect(
											(el = document
													.getElementById("select-service-item")),
											{
												copyClassesToDropdown : false,
												dropdownParent : "body",
												controlInput : "<input>",
				...
				.addEventListener(
						...
						function() {
							...
							window.TomSelect
									&& new TomSelect(
											(el = document
													.getElementById("select-variation-option")),
											{
												copyClassesToDropdown : false,
												dropdownParent : "body",
												controlInput : "<input>",
